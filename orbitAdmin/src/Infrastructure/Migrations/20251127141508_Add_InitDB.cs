        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EndpointAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EndpointEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EndpointGe = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTypes_ProjectTypes_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_Deleted",
                table: "Positions",
                column: "Deleted");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTypes_Deleted",
                table: "ProjectTypes",
                column: "Deleted");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTypes_ParentId",
                table: "ProjectTypes",
                column: "ParentId");
