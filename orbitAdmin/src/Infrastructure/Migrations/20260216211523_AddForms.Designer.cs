...
namespace SchoolV01.Infrastructure.Migrations
{
    ...
    [Migration("20260216211523_AddForms")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.Clinic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.FormCompany", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FormNumber")
                        .IsUnique()
                        .HasFilter("[FormNumber] IS NOT NULL");

                    b.ToTable("FormCompanies");
                });

            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.FormCompanyAttachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FormCompanyId");

                    b.ToTable("FormCompanyAttachments");
                });

            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.Hospital", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.Clinic", b =>
                {
                    ...
                    b.HasOne("SchoolV01.Domain.Entities.GeneralSettings.Directorate", "Directorate")
                        .WithMany()
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.FormCompanyAttachment", b =>
                {
                    b.HasOne("SchoolV01.Domain.Entities.GeneralSettings.FormCompany", "FormCompany")
                        .WithMany("Attachments")
                        .HasForeignKey("FormCompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("FormCompany");
                });
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.ProjectType", b =>
                {
                    b.HasOne("SchoolV01.Domain.Entities.GeneralSettings.ProjectType", "Parent")
                        .WithMany("SubProjectTypes")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("SchoolV01.Domain.Entities.GeneralSettings.Supplier", b =>
                {
                    ...
                    b.HasOne("SchoolV01.Domain.Entities.GeneralSettings.Position", "Position")
                        .WithMany()
