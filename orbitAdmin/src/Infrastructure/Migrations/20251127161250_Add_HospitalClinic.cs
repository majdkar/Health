...
{
    /// <inheritdoc />
    public partial class Add_HospitalClinic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ByDirectorate = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clinics_Directorates_DirectorateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Hospitals_Directorates_DirectorateId",
                        column: x => x.DirectorateId,
                        principalTable: "Directorates",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Suppliers_Positions_PositionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Clinics_Deleted",
                table: "Clinics",
                column: "Deleted");

            migrationBuilder.CreateIndex(
                name: "IX_Clinics_DirectorateId",
                table: "Clinics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hospitals_Deleted",
                table: "Hospitals",
                column: "Deleted");

            migrationBuilder.CreateIndex(
                name: "IX_Hospitals_DirectorateId",
                table: "Hospitals",
                column: "DirectorateId");
