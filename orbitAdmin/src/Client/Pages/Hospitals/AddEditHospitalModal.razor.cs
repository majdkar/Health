...
namespace SchoolV01.Client.Pages.Hospitals
{
    public partial class AddEditHospitalModal
    {
        ...
        {
            _processing = true;
            var response = await HospitalManager.SaveAsync(AddEditHospitalModel);
