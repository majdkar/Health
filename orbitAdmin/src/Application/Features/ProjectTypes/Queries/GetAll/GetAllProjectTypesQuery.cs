...
{
    public class GetAllProjectTypesQuery : IRequest<Result<List<GetAllProjectTypesResponse>>>
    {
        public GetAllProjectTypesQuery()
        {
        }
    }

    internal class GetAllProjectTypesCachedQueryHandler
        : IRequestHandler<GetAllProjectTypesQuery, Result<List<GetAllProjectTypesResponse>>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;
        private readonly IMapper _mapper;
        private readonly IAppCache _cache;

        public GetAllProjectTypesCachedQueryHandler(
            ...
            CancellationToken cancellationToken)
        {
            ...
            var rootNodes = mapped.Where(x => x.ParentId == null).ToList();
